...
add_filter( 'woocommerce_cart_item_name', 'ibrohim_cart_item_delivery_time', 10, 3 );

function ibrohim_cart_item_delivery_time( $product_name, $cart_item, $cart_item_key ) {
